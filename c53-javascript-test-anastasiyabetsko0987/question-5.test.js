...
describe('combineAndDeduplicate', () => {
  it('should return first array if second is not array', () => {
    const result = combineAndDeduplicate([1, 2, 3], undefined);
    expect(result).toEqual([1, 2, 3]);
  });
  it('should return second array if first is not array', () => {
    const result = combineAndDeduplicate(undefined, [1, 2, 3]);
    expect(result).toEqual([1, 2, 3]);
  });
  it('should return deduplicated array if both array are valid', () => {
    const result = combineAndDeduplicate([1, 2, 3], [3, 4, 5]);
