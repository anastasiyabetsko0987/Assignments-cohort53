...
## Submission
You may commit and push code as many times as you want until the deadline. After the deadline, you will automatically lose write access to the repo. Please make sure to push everything before the deadline.
...
2. You are allowed to use AI (like chatGPT) only to get help with questions or clarification. YOU MAY NOT USE AI TO WRITE THE CODE FOR YOU.
